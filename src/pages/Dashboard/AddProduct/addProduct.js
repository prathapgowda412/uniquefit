				...
				<FormControl className={classes.formcontainer}>
					...
					<FormGroup encty>
						<Container maxWidth="sm" className={classes.addproductcont}>
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Name :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Price :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Sale Price :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Material :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Description :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Color :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Pattern :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Type :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Occasion :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product Feel :</FormLabel>
								</Grid>
								<Grid xs={6}>
									<TextField
										size="medium"
							...
							<Grid container className={classes.formbox} direction="row" alignItems="center">
								<Grid xs={5}>
									<FormLabel className={classes.labelname}>Product images :</FormLabel>
								</Grid>
								<Grid xs={6}>
									{/* <input
															type="file"
							...
							<Grid>
								{/* <input
														...
														placeholder="Submit"
													/> */}
								<Button onClick={onsubmitproduct} className={classes.addproductbutton}>
									Add Product
								</Button>
							</Grid>
						</Container>

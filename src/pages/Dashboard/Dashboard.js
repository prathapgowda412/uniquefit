...
import { Container, Grid, Hidden, Box, Button, Typography } from '@material-ui/core';
...
import { AssessmentRounded, Person, ShoppingCartRounded, ViewListRounded } from '@material-ui/icons';
		...
		<Grid item container xs={12}>
			<Grid item container xs={12} className={classes.header}>
				<Grid xs={2}>
					...
					<img alt="uniquefit" height="60px" src={require('../../logos/Uniquefit logo.svg')} />
				</Grid>

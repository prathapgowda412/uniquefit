          ...
          <Grid item container xs={12} sm={6} className={classes.showdesc}>
            ...
            >
              ...
              <Box className={classes.pricebox}>
                ...
                <Typography>
                  Rs{' '}
                  <strike className={classes.salepricetag}>
                    {' '}
                    {product.productprice}
                  </strike>{' '}
                </Typography>
              </Box>
              <Typography className={classes.inclusivetext}>
                {' '}
                inclusive of all taxes
              </Typography>
              <Link
                className={classes.Link}
                to={`/Customize/${product.productid}`}
              >
              ...
              <Box>
                <Typography variant='body1'>
                  Made in India. Wear this to feel and look your best. You can
                  style this to your taste and that fits you.{' '}
                </Typography>
              </Box>
              <br />
              <Typography className={classes.nametitle} variant='body1'>
                Product code :{' '}
                <em className={classes.prodtext}>{product.productid} </em>
              </Typography>
              <Typography className={classes.nametitle} variant='body1'>
                Shirt type:{' '}
                <em className={classes.prodtext}>{product.producttype} </em>
              </Typography>
              <Typography className={classes.nametitle} variant='body1'>
                Shirt pattern:{' '}
                <em className={classes.prodtext}>{product.productpattern} </em>
              </Typography>
              <Typography className={classes.nametitle} variant='body1'>
                Product color :{' '}
                <em className={classes.prodtext}>{product.productcolor} </em>
              </Typography>
              <Typography className={classes.nametitle} variant='body1'>
                Product material :{' '}
                <em className={classes.prodtext}>{product.productmaterial} </em>
              </Typography>
              <Typography className={classes.nametitle} variant='body1'>
                Product feel :{' '}
                <em className={classes.prodtext}>{product.productfeel} </em>
              </Typography>
        ...
        <Grid container>
          ...
          <Grid item xs={12} sm={6}>
            <Container>
              ...
              <Skeleton width={250} height={40} variant='text' />
              <Skeleton width={250} height={40} variant='text' />
              <Skeleton width={220} height={40} variant='text' />
              <Skeleton width={180} height={40} variant='text' />
              <Skeleton width={260} height={40} variant='text' />
            </Container>
          </Grid>
        </Grid>
      )}

...
import { addOrder, getCartItems, getCouponByCode } from '../../services/fetchService';
		...
		const options = {
			...
			handler: async (response) => {
				try {
					...
					if (captured) {
						console.log('success');
						let { data } = await addOrder(cartItems, address, size, height, shoulders, bodyType, bodyFit);
										...
										<Card elevation square className={classes.itemcard} key={index}>
											<CardContent className={classes.cardcontent}>
												<Paper elevation className={classes.cardpaper}>
													<img className={classes.itemimg} src={ite.productimages[0]} />
								...
								<RadioGroup row aria-label="position" name="position" defaultValue="top">
									...
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="2XL-46"
											control={
												<Radio value="2XL-46" onClick={handlesizechange} color="primary" />
											}
											label="2XL-46"
										/>
									</Paper>
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="3XL-48"
											control={
												<Radio value="3XL-48" onClick={handlesizechange} color="primary" />
											}
											label="3XL-48"
										/>
									</Paper>
								...
								<RadioGroup row aria-label="position" name="position" defaultValue="top">
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="Skinny"
											control={
												<Radio value="Skinny" onClick={handlebodytypechange} color="primary" />
											}
											label="Skinny"
										/>
									</Paper>
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="Athletic"
											control={
												<Radio value="Sloping" onClick={handlebodytypechange} color="primary" />
											}
											label="Athletic"
										/>
									</Paper>
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="Average"
											control={
												<Radio value="Average" onClick={handlebodytypechange} color="primary" />
											}
											label="Average"
										/>
									</Paper>
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="Healthy"
											control={
												<Radio value="Healthy" onClick={handlebodytypechange} color="primary" />
											}
											label="Healthy"
										/>
									</Paper>
								...
								<RadioGroup row aria-label="position" name="position" defaultValue="top">
									...
									<Paper className={classes.sizepaper}>
										...
										<FormControlLabel
											value="Baggy"
											control={
												<Radio value="Baggy" onClick={handlebodyfitchange} color="primary" />
											}
											label="Baggy"
										/>
									</Paper>
			...
			<Grid item container xs={12} className={classes.root} justify="center">
				{cartquantity !== 0 ? (
					...
					<Grid xs={12}>
						...
						<Hidden xsDown>
							<Link to="/Shop">
								<img className={classes.emptyimg} src={require('./statics/Empty_Bag_1.svg')} />
							</Link>
						</Hidden>
					</Grid>
				)}
